            ...
            <div className="card-body p-5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <label className="form-label" htmlFor="form3Example1cg">Your Username</label>
                  ...
                  <input type="text" id="form3Example1cg" className="form-control form-control-lg" placeholder='Enter username' name='username' value={inputs.username} onChange={handleChange}/>
                </div>
                <div className="form-outline mb-4">
