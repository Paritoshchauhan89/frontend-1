 ...
 <div className="d-flex">
  ...
  <div className="container mt-4 mb-3">
          ...
          <form className="row g-3 needs-validation" noValidate>
            ...
            <div class="col-md-3">
    <label for="validationCustom04" class="form-label">Organizer Country</label>
    <select class="form-select" id="validationCustom04" required onChange={(e)=>onValueChange(e)} name='organizercountry' value={organizer.organizercountry}> 
